...
export default {
    ...
    methods: {
            ...
            if (this.tip) {
                ...
                this.tipContainer
                    ...
                    .attr('x', this.coord(event, (t, l) => {
                        if ((event.x + 90 * this.width / 300) > this.width) {
                            return { x: -90, y: 0 };
                        } else {
                            return { x: 0, y: 0 };
                        }
                    ...
                    .attr('y', this.coord(event, (t, l) => {
                        if ((event.y - t + 60 * this.height / 300) > this.height) {
                            return { x: 0, y: -60 };
                        } else {
                            return { x: 0, y: 0 };
                        }
        ...
        coord (e, co) {
            ...
            return {
                x: e.x / this.width * 300 - offsetLeft + (co ? co(offsetTop, offsetLeft).x : 0),
                y: e.y / this.height * 300 - offsetTop + (co ? co(offsetTop, offsetLeft).y : 0)
            }
        }
    }
}
